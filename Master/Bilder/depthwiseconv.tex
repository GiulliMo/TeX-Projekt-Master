...
\begin{figure}[H]
			...
			\end{tikzpicture}
			\caption{Prinzipdarstellung einer tiefenorintierten, trennbaren Konvolution. Große, rechteckige und dreidimensional dargestellte Boxen zeigen die Tiefenebenen eines Bidles. Die kleinen, feinmaschigen, dreidimensionalen Strukturen deuten Kernel an. \cite{depthwiseconv} }
