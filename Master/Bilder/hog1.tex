...
\begin{figure}[H]
	...
	\addplot[gray!50, line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/hog.csv};
	\addplot[black, line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/hogcoco.csv};
