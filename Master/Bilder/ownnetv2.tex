...
\begin{figure}[H]
	...
	\end{axis}
	\end{tikzpicture}
	\caption{\textit{Precision-Recall}-Kurven des eiegenen \textit{SSD MobileNet V2} Netz. Die schwarze Kurve beschreibt die Analyse durch den \textit{COCO}-Datensatz. Der Test mithilfe des eigenen Datensatz wir durch die graue Kurve präsentiert. https://github.com/kaka-lin/object-detection}
