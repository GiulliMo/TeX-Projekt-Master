...
\begin{figure}[H]
	...
	\addplot[gray!50, line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/ownnetv2.csv};
	\addplot[line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/ownnetv2coco.csv};
	...
	\end{axis}
	\end{tikzpicture}
	\caption{\textit{Precision-Recall} Kurven des entwickelten \textit{SSD MobileNet V2} Netz.}
	\label{fig: ownnetv2}
\end{figure}
