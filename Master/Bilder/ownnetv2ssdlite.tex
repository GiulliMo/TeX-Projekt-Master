...
\begin{figure}[H]
	...
	\addplot[gray!50, line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/ownnetv2ssdlite.csv};
	\addplot[line width=1pt]  table [x=Step,y=Value,col sep=comma] from {Bilder/ownnetv2ssdlitecoco.csv};
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Darstellung der \textit{Precision-Recall} Verläufe des entwickelten \textit{MobileNet V2 SSDLite} Netz.}
