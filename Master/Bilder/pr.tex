...
\begin{table}[H]
	\caption{Tabelle mit Beispielen zur Erklärung der Begriffe \textit{True Positive}, \textit{False Positive}, \textit{False Negative} und \textit{True Negative}. In der jeweiligen Zelle wird ein Beispiel im praktischen Kontext der Personenerkennung genannt.}
	\begin{center}
