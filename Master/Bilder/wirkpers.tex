...
\node[CONSENSsys] (sys1) at (0,0) {Personen-\\detektion};
...
\draw[CSarrow,dashed] (sys1) -- node[midway,left,align=center,font=\scriptsize]{Bounding\\Box}(sys6);
\draw[CSarrow,dashed] (sys1) -- (sys2) node[align=center,font=\scriptsize,above] at (1.75,0.2){Bounding\\Box\\Person};
\draw[CSarrow,dashed] (sys2) -- (sys3) node[align=center,font=\scriptsize,above] at (5.25,0.2){Bounding\\Box\\Gesicht};
...
\draw[CSarrow,dashed] (sys2.333) -- node[midway,above,align=center,font=\scriptsize]{Gesicht}(sys3.207);
\draw[CSarrow,dashed] (-2,0.5) -- (sys1.153);
\draw[CSarrow,dashed] (-2,-0.5) -- (sys1.207) node[font=\scriptsize,align=center] at (-2.5,0){Bildinformationen\\Kinect 1 \& 2};
\draw[CSarrow,dashed] (sys3.27) -- (9,0.5) node[above,font=\scriptsize,align=center] at (9.5,0.5){Position\\d. Person};
\draw[CSarrow,dashed] (sys3.333) -- (9,-0.5) node[above,font=\scriptsize,align=center] at (9.5,-0.5){Status-\\informationen};
